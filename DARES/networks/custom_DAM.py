...
Original file is located at
    https://colab.research.google.com/drive/1sTonWQo6281l4qL73lHDGV-YvmQqkD4R
"""
...
class Customised_DAM(nn.Module):
    def __init__(self,):
        ...
        for t_layer_i, blk in enumerate(self.backbone.encoder.layer):
            ...
            dim2 = blk.attention.attention.key.in_features
            w_a_linear_q = nn.Linear(dim, r, bias=False)
            w_b_linear_q = nn.Linear(r, dim, bias=False)
            w_a_linear_v = nn.Linear(dim2, r, bias=False)
            w_b_linear_v = nn.Linear(r, dim2, bias=False)
